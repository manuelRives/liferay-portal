...
<liferay-frontend:side-panel-content
	screenNavigatorKey="<%= CommerceReturnItemScreenNavigationConstants.CATEGORY_KEY_COMMERCE_RETURN_ITEM_DETAIL %>"
	title='<%= LanguageUtil.get(request, "edit-comment") %>'
/>

<portlet:actionURL name="/commerce_return/edit_commerce_return_item_comment" var="editCommerceReturnItemCommentActionURL">
	<portlet:param name="mvcRenderCommandName" value="/commerce_return/edit_commerce_item_comment" />
</portlet:actionURL>
